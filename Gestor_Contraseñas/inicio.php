...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <h1>
    <a class="navbar-brand" href="#">HatStall Security</a>
    </h1>
  ...
  <div class="row g-0">
    <div class="col">
      <div class="card-body text-center">
        ...
        <p class="card-text">Nos encargamos de resguardar tu seguridad. <br> <br> ¡Ya puedes gestionar tus credenciales privadas, puedes ver los usuarios a tu cargo, los diferentes grupos de trabajo que hay, las credenciales disponibles o agregar un nuevo usuario!</p>
      </div>
    </div>
  </div>
</div>

  ...
  <div class="row g-0">
    <div class="col">
      <div class="card-body text-center">
        ...
        <p class="card-text">Nos encargamos de resguardar tu seguridad. <br> <br> ¡Ya puedes gestionar las credenciales privadas de tu grupo, puedes ver los usuarios a tu cargo y solicitar las credenciales que necesites a algun administrador!</p>
      </div>
    </div>
  </div>
</div>
